          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                Never miss your medication again. MedsTracker helps you stay on top of your health 
                with smart reminders, medication tracking, and detailed health insights.
              </p>
                ...
                <div className="absolute inset-4 bg-gray-900 rounded-[2rem] overflow-hidden">
                  ...
                  <div className="px-4 pb-4">
                    <div className="text-center mb-6">
                      <h2 className="text-2xl font-bold text-cyan-400 mb-2">MedsTracker</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-cyan-500/10 to-pink-500/10 p-6 rounded-xl border border-cyan-500/20">
              ...
              <p className="text-gray-400">
                Customizable notifications that adapt to your schedule and never let you miss a dose.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-pink-500/10 to-purple-500/10 p-6 rounded-xl border border-pink-500/20">
              ...
              <p className="text-gray-400">
                Track your adherence and view detailed insights about your medication routine.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-500/10 to-cyan-500/10 p-6 rounded-xl border border-purple-500/20">
              ...
              <p className="text-gray-400">
                Your health data is encrypted and stored securely. Privacy is our top priority.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-gray-300 text-lg mb-12">
            We're putting the finishing touches on MedsTracker. Join our waitlist to be the first 
            to download when we launch!
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-2xl mx-auto">
            <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-8 rounded-xl border border-gray-700">
              ...
              <Badge variant="outline" className="text-cyan-400 border-cyan-400/50">Coming Soon</Badge>
            </div>
            ...
            <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-8 rounded-xl border border-gray-700">
              ...
              <Badge variant="outline" className="text-pink-400 border-pink-400/50">Coming Soon</Badge>
            </div>
          </div>
        </div>
      </section>
