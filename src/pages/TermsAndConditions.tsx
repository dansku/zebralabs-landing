    ...
    <div className="min-h-screen bg-[#0f0f23] text-white">
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="prose prose-invert max-w-none space-y-6 text-gray-300">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-white mt-8">2. Account Registration</h2>
            
            <h3 className="text-xl font-semibold text-cyan-400">2.1 Account Creation</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold text-cyan-400">2.2 Account Termination</h3>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-white mt-8">3. License to Use Services</h2>
            
            <h3 className="text-xl font-semibold text-cyan-400">3.1 Grant of License</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold text-cyan-400">3.2 License Restrictions</h3>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-white mt-8">4. User Content</h2>
            
            <h3 className="text-xl font-semibold text-cyan-400">4.1 Your Content</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold text-cyan-400">4.2 Content Standards</h3>
            ...
            <h3 className="text-xl font-semibold text-cyan-400">4.3 Content Removal</h3>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-white mt-8">5. Intellectual Property Rights</h2>
            
            <h3 className="text-xl font-semibold text-cyan-400">5.1 Our Rights</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold text-cyan-400">5.2 Trademarks</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold text-cyan-400">5.3 Copyright Infringement</h3>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-white mt-8">6. Privacy</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-white mt-8">7. Purchases and Payments</h2>
            
            <h3 className="text-xl font-semibold text-cyan-400">7.1 In-App Purchases</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold text-cyan-400">7.2 Subscriptions</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold text-cyan-400">7.3 Refund Policy</h3>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-white mt-8">9. Disclaimers</h2>
            
            <h3 className="text-xl font-semibold text-cyan-400">9.1 As-Is Basis</h3>
            <p>
              THE SERVICES ARE PROVIDED "AS IS" AND "AS AVAILABLE" WITHOUT WARRANTIES OF ANY KIND, EITHER EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, TITLE, AND NON-INFRINGEMENT.
            </p>

            <h3 className="text-xl font-semibold text-cyan-400">9.2 No Guarantee</h3>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-white mt-8">11. Indemnification</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-white mt-8">12. Governing Law and Dispute Resolution</h2>
            
            <h3 className="text-xl font-semibold text-cyan-400">12.1 Governing Law</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold text-cyan-400">12.2 Dispute Resolution</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold text-cyan-400">12.3 Exceptions</h3>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-white mt-8">13. Changes to Terms</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-white mt-8">14. General Provisions</h2>
            
            <h3 className="text-xl font-semibold text-cyan-400">14.1 Entire Agreement</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold text-cyan-400">14.2 Severability</h3>
            <p>
              If any provision of these Terms is found to be invalid or unenforceable, the remaining provisions shall continue in full force and effect.
            </p>

            <h3 className="text-xl font-semibold text-cyan-400">14.3 Waiver</h3>
            <p>
              No waiver of any term or condition shall be deemed a further or continuing waiver of such term or any other term.
            </p>

            <h3 className="text-xl font-semibold text-cyan-400">14.4 Assignment</h3>
            <p>
              You may not assign or transfer these Terms without our prior written consent. We may assign our rights and obligations without restriction.
            </p>

            <h3 className="text-xl font-semibold text-cyan-400">14.5 Force Majeure</h3>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-white mt-8">15. App Store Additional Terms</h2>
            
            <h3 className="text-xl font-semibold text-cyan-400">15.1 Apple App Store</h3>
            <p>If you download our app from the Apple App Store:</p>
            <ul className="list-disc pl-6 space-y-2">
            ...
            <h3 className="text-xl font-semibold text-cyan-400">15.2 Google Play Store</h3>
            <p>If you download our app from Google Play Store:</p>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-white mt-8">16. Contact Information</h2>
